...
public class OleOutlineTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    // constructors
    public OleOutlineTextView(Context context) {
        this(context, null, 0);
    }

    public OleOutlineTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OleOutlineTextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.OutlineTextView);
            _strokeColor = a.getColor(R.styleable.OutlineTextView_textStrokeColor,
                    getCurrentTextColor());
            _strokeWidth = a.getFloat(R.styleable.OutlineTextView_textStrokeWidth,
