...
public class OlePreviewFieldViewA extends FrameLayout {
    ...
    private PreviewFieldACallback previewFieldACallback;
    private PreviewFieldItemCallback previewFieldItemCallback;
    float CLICK_ACTION_THRESHOLD = 10.0f;
    float startX = 0, startY = 0;

    public OlePreviewFieldViewA(@NonNull Context context) {
        super(context);
        initView(context, null);
        this.context = context;
    }

    public OlePreviewFieldViewA(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
        this.context = context;
    }

    public OlePreviewFieldViewA(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
        this.context = context;
    }

    public void setPreviewFieldACallback(PreviewFieldACallback previewFieldACallback) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        View.inflate(getContext(), R.layout.olepreview_field_view_a, this);
    ...
    public interface PreviewFieldACallback {
        void didStartDrag();
