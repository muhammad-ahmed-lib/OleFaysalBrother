...
public class OleKeyboardUtils implements ViewTreeObserver.OnGlobalLayoutListener
{
    ...
    private static final HashMap<SoftKeyboardToggleListener, OleKeyboardUtils> sListenerMap = new HashMap<>();
    ...
    public static void addKeyboardToggleListener(Activity act, SoftKeyboardToggleListener listener)
    {
        ...
        sListenerMap.put(listener, new OleKeyboardUtils(act, listener));
    }
    ...
    public static void removeKeyboardToggleListener(SoftKeyboardToggleListener listener)
    {
        ...
        {
            OleKeyboardUtils k = sListenerMap.get(listener);
            k.removeListener();
    ...
    private OleKeyboardUtils(Activity act, SoftKeyboardToggleListener listener)
    {
        mCallback = listener;
