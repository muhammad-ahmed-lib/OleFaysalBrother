...
public class DateRangeFilterDialogFragment extends DialogFragment implements View.OnClickListener {

    private FragmentEmpReviewFilterDialogBinding binding;
    private String fromDate = "", toDate = "";
    private DateRangeFilterDialogFragmentCallback fragmentCallback;

    public DateRangeFilterDialogFragment() {
        // Required empty public constructor
    }

    public DateRangeFilterDialogFragment(String fromDate, String toDate) {
