...
import ae.oleapp.R;
import ae.oleapp.databinding.FragmentPaymentWebDialogBinding;
...
public class OlePaymentWebDialogFragment extends DialogFragment {

    private FragmentPaymentWebDialogBinding binding;
    private String urlStr = "";
    private PaymentWebCallback paymentCallback;
    private String result = null;

    public OlePaymentWebDialogFragment() {
        // Required empty public constructor
    }

    public OlePaymentWebDialogFragment(String urlStr) {
        this.urlStr = urlStr;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPaymentWebDialogBinding.inflate(inflater, container, false);
