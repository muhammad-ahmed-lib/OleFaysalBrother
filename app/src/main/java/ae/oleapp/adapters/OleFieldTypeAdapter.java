...
public class OleFieldTypeAdapter extends RecyclerView.Adapter<OleFieldTypeAdapter.ViewHolder> {
    ...
    public OleFieldTypeAdapter(Context context, List<OleFieldDataChild> list, int selectedIndex) {
