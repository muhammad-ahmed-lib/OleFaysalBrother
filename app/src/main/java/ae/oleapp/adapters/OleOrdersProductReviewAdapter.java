...
public class OleOrdersProductReviewAdapter extends RecyclerView.Adapter<OleOrdersProductReviewAdapter.ViewHolder> {

    private final Context context;
    private final List<Product> list;
    private ItemClickListener itemClickListener;

    public OleOrdersProductReviewAdapter(Context context, List<Product> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.oleorder_review, parent, false);
