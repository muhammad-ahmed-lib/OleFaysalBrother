...
public class OleFlashDealsAdapter extends RecyclerView.Adapter<OleFlashDealsAdapter.ViewHolder> {

    private final Context context;
    private final List<Product> list;
    private ItemClickListener itemClickListener;

    public OleFlashDealsAdapter(Context context, List<Product> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.oleflash_deal, parent, false);
