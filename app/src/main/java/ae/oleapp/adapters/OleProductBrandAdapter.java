...
public class OleProductBrandAdapter extends RecyclerView.Adapter<OleProductBrandAdapter.ViewHolder> {

    private final Context context;
    private final List<OleProductBrand> list;
    private ItemClickListener itemClickListener;

    public OleProductBrandAdapter(Context context, List<OleProductBrand> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.oleproduct_brand, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        OleProductBrand brand = list.get(position);
