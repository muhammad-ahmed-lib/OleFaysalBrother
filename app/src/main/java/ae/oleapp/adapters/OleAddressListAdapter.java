...
public class OleAddressListAdapter extends RecyclerView.Adapter<OleAddressListAdapter.ViewHolder> {

    private final Context context;
    private List<OleShopAddress> list;
    private ItemClickListener itemClickListener;
    private int selectedIndex = -1;
    private boolean isPickup = false;

    public OleAddressListAdapter(Context context, List<OleShopAddress> list, boolean isPickup) {
    ...
    public void setDatasource(List<OleShopAddress> list, boolean isPickup) {
        this.list = list;
        this.isPickup = isPickup;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.oleaddress_list, parent, false);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        OleShopAddress address = list.get(position);
