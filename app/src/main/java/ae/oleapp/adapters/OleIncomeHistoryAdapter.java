...
public class OleIncomeHistoryAdapter extends RecyclerView.Adapter<OleIncomeHistoryAdapter.ViewHolder>{

    private final Context context;
    private final List<IncomeHistory> list;
    private ItemClickListener itemClickListener;
    private String selectedId = "";


    public OleIncomeHistoryAdapter(Context context, List<IncomeHistory> list) {
