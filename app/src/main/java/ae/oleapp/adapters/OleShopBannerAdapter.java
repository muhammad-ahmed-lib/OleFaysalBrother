...
public class OleShopBannerAdapter extends AbsBannerAdapter {

    private final List<OleShopBanner> list;
    private final Context context;
    private ItemClickListener itemClickListener;

    public OleShopBannerAdapter(Context context, List<OleShopBanner> list) {
