...
public class OleProductListAdapter extends RecyclerView.Adapter<OleProductListAdapter.ViewHolder> {
    ...
    public OleProductListAdapter(Context context, List<Product> list, boolean setManualWidth) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.oleshop_product, parent, false);
        if (setManualWidth) {
