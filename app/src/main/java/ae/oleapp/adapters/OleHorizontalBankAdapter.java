...
public class OleHorizontalBankAdapter extends RecyclerView.Adapter<OleHorizontalBankAdapter.ViewHolder> {
    ...
    public OleHorizontalBankAdapter(Context context, List<ClubBankLists> list) {
