...
public class OleCheckoutAdapter extends RecyclerView.Adapter<OleCheckoutAdapter.ViewHolder> {

    private final Context context;
    private final List<Object> list;

    public OleCheckoutAdapter(Context context, List<Object> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.olecheckout_item, parent, false);
    ...
    private void populateData(Product product, ViewHolder holder) {
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(context, RecyclerView.HORIZONTAL, false);
        holder.recyclerView.setLayoutManager(layoutManager);
        OleCartVariantAdapter adapter = new OleCartVariantAdapter(context, product.getAttributes());
        holder.recyclerView.setAdapter(adapter);
