...
public class VariantOptionAdapter extends RecyclerView.Adapter<VariantOptionAdapter.ViewHolder> {
    ...
    public VariantOptionAdapter(Context context, List<String> list) {
