...
public class OleFieldSizeAdapter extends RecyclerView.Adapter<OleFieldSizeAdapter.ViewHolder> {
    ...
    public OleFieldSizeAdapter(Context context, List<OleFieldDataChild> list, int selectedIndex) {
